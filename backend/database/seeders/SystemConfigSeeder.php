...
class SystemConfigSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $configs = [
            ...
            ['group' => 'payment', 'key' => 'wechat.app_id', 'value' => '', 'is_sensitive' => true, 'description' => '微信 App ID'],
            ...
            ['group' => 'payment', 'key' => 'alipay.public_key', 'value' => '', 'is_sensitive' => true, 'description' => '支付宝公钥'],
